...
#ifndef SCRIPT_INTERFACE_VIRTUAL_SITES_VIRTUAL_SITES_WALBERLA_MOVING_BOUNDARY_HPP
#define SCRIPT_INTERFACE_VIRTUAL_SITES_VIRTUAL_SITES_WALBERLA_MOVING_BOUNDARY_HPP
...
private:
  std::shared_ptr<::VirtualSitesWalberlaMovingBoundary> m_virtual_sites;
};
